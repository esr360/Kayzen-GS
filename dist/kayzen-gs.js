...
var Row = function (_React$Component) {
    ...
    function Row(props, context) {
        ...
        } else if (_this.props.stack === false) {
...
var Column = function (_React$Component) {
    ...
    function Column(props, context) {
        ...
        if (_this.width) {
            if (_typeof(_this.width) === 'object') {
                for (var width in _this.width) {
                    if (width === 'default') {
                        _this.class = _this.class + '-' + _this.width.default;
                    } else {
                        _this.class = _this.class + ' ' + width + '-' + _this.width[width];
                    }
                }
            } else {
                _this.class = _this.class + '-' + _this.width;
            }
        };

        if (_this.props.push) _this.class = _this.class + ' push-' + _this.props.push;
        if (_this.props.pull) _this.class = _this.class + ' pull-' + _this.props.pull;

        if (_this.props.align) {
            _this.class = _this.class + ' va-' + _this.props.align;
        }
        return _this;
    }
    ...
    _createClass(Column, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                this.tag,
                _extends({}, this.props, { className: this.class }),
                this.props.children
            );
        }
    }]);
